...
export class AlterPhoneAttributeUniqueness1676900183425
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_f44d0cd18cfd80b0fed7806c3b\` ON \`user_profile\``,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`IDX_f44d0cd18cfd80b0fed7806c3b\` ON \`user_profile\` (\`id\`)`,
    );
    await queryRunner.query(
